...
therockk=face_recognition.load_image_file("/Users/aryansheel/Desktop/python/facial_rec/therock.jpg")
encoding5=face_recognition.face_encodings(therockk)[0]

known_face_encodings=[my_encoding,encoding2,encoding3,encoding4,encoding5]
known_face_names=["aryan","muthres","devesh","harsh","the rock"]
